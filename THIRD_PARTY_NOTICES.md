...
- Qwen3 and Qwen3.5 model artifacts are Copyright Alibaba Cloud and licensed under Apache-2.0.
- MLX and MLX-LM are provided by Apple machine learning research contributors under their
  respective open-source licenses.
- OpenR1-Math-220k is provided by the Hugging Face Open R1 team under Apache-2.0 and contains
  verified reasoning traces generated with DeepSeek-R1.
